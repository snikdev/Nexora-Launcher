package org.nexoralauncher;

import org.nexoralauncher.utils.Parameters;
...
public final class SystemProperties {
    public static void apply(Parameters params) {
        ...
        if (name != null)
            System.setProperty("org.nexoralauncher.instance.name", name);
        if (iconId != null)
            System.setProperty("org.nexoralauncher.instance.icon.id", iconId);
        if (iconPath != null)
            System.setProperty("org.nexoralauncher.instance.icon.path", iconPath);
        if (windowTitle != null)
            System.setProperty("org.nexoralauncher.window.title", windowTitle);
        if (windowDimensions != null)
            System.setProperty("org.nexoralauncher.window.dimensions", windowDimensions);
