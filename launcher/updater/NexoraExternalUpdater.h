...
class NexoraExternalUpdater : public ExternalUpdater {
    Q_OBJECT

   public:
    NexoraExternalUpdater(QWidget* parent, const QString& appDir, const QString& dataDir);
    ~NexoraExternalUpdater() override;
