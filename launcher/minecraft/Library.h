...
class Library {
   ...
   private: /* methods */
    /// the default storage prefix used by Nexora Launcher
   ...
   protected: /* data */
    ...
    /// DEPRECATED: Nexora Launcher-specific absolute URL. takes precedence over the implicit maven repo URL, if defined
    QString m_absoluteURL;

    /// Nexora Launcher extension - filename override
    QString m_filename;

    /// DEPRECATED Nexora Launcher extension - display name
    QString m_displayname;

    /**
     * Nexora Launcher-specific type hint - modifies how the library is treated
     */
    QString m_hint;

    /**
     * storage - by default the local libraries folder in Nexora Launcher, but could be elsewhere
     * Nexora Launcher specific, because of FTB.
     */
